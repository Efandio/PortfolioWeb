...
const myProjects = [
    {
        ...
        description: 'A simple e-commerce website with some features like cart, checkout, and more.',
        tech: [
            'TypeScript',
            'React',
            'React Router',
    ...
    },
    {
        ...
        description: 'A simple anime information website using data from the Anilist API.',
    ...
    },
    {
        ...
        description: 'Simple responsive landing page for photographer',
        tech: ['Astro', 'React'],
        image: '/landing.png',
        link: {
            icon: {
            ...
            deploy: 'https://demo1-beige-six.vercel.app/',
            repo: 'https://github.com/Efandio/demo1'
        }
    }
];
